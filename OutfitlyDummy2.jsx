        ...
        {outfit.hose && (() => {
          ...
          if (isShorts) return (
            <g opacity="0.9">
              ...
              {/* Linkes Bein kurz bis Oberschenkelmitte */}
              <path d="M 50 258 L 80 260 L 80 360 C 76 362 70 363 65 362 C 60 361 56 358 55 354
                       L 50 316 C 49 304 49 290 50 280 Z" fill={f}/>
              {/* Rechtes Bein kurz */}
              <path d="M 110 258 L 80 260 L 80 360 C 84 362 90 363 95 362 C 100 361 104 358 105 354
                       L 110 316 C 111 304 111 290 110 280 Z" fill={f}/>
              {/* Mittelnaht */}
              <line x1="80" y1="288" x2="80" y2="360" stroke={darken(f)} strokeWidth="1" opacity="0.35"/>
              {/* Shorts-Abschlusskante */}
              <path d="M 50 354 C 58 360 70 363 80 362 C 90 363 102 360 110 354"
                fill="none" stroke={darken(f)} strokeWidth="1.5" opacity="0.6"/>
              {/* Gürtelschlaufen */}
          ...
          return (
            <g opacity="0.9">
              ...
              <path d="M 37 86 C 28 90 22 102 20 115 L 18 155 C 17 170 17 182 19 192
                       L 22 218 C 24 230 26 252 28 270 C 29 284 30 298 30 310
                       C 30 318 32 322 36 322 C 40 322 43 318 44 310
                       L 46 290 C 47 274 47 258 46 242 L 44 216
              ...
              <path d="M 123 86 C 132 90 138 102 140 115 L 142 155 C 143 170 143 182 141 192
                       L 138 218 C 136 230 134 252 132 270 C 131 284 130 298 130 310
                       C 130 318 128 322 124 322 C 120 322 117 318 116 310
                       L 114 290 C 113 274 113 258 114 242 L 116 216
